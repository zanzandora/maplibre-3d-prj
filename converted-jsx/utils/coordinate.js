 ...
 */
export const WGS84_TO_MERCATOR = (lng, lat, alt = 0) => {
 ...
 */
export const getRelativePosition = (lng, lat, alt, center) => {
 ...
 */
export const isWithinBounds = (lng, lat, bounds) => {
  return (
    lng >= bounds.minLng &&
    lng <= bounds.maxLng &&
    lat >= bounds.minLat &&
 ...
 */
export const getRelativeRotation = (yaw = 0, pitch = 0, roll = 0) => {
